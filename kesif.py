...
def grab_banner(target_ip, target_port):
    ...
    try:
        print(Fore.BLUE + f"[*] TCP soketi (telefon) oluşturuluyor...")
        # İşte hata aldığın 's' burada tanımlanıyor!
        ...
        if banner:
            ...
            print(Fore.YELLOW + "[!] Servis yanıt vermedi.")
        print(Fore.MAGENTA + "===============================================")
        ...
        print(Fore.RED + f"[-] HATA: Zaman aşımı! Güvenlik duvarı bağlantıyı engelliyor olabilir.")
